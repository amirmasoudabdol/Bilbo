...
[Stashing policy](/decision-strategies.md#stashing-policy) indicates what type of outcomes should temporary be stored by Researcher for further exploration of his results. After leaving the Hacking Workflow, Researcher is equipped with a set of outcomes selected from his ventures into his QRP arsenal. Researcher is being given the chance of selecting an outcome from his stashed outcome, **Hacked Outcomes DB.**, if he finds it necessary. 
