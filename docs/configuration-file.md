...
<!-- entire  a full research as described in [Execution Flow](flow.md) and [Research Workflow](research-workflow.md). Moreover, we will discuss how processes of execution,  -->
